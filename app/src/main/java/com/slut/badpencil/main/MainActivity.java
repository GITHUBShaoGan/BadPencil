package com.slut.badpencil.main;
...
public class MainActivity extends AppCompatActivity
    ...
    private void initView() {
        ...
        pagerAdapter = new PagerAdapter(getSupportFragmentManager(), fragmentList, getResources().getStringArray(R.array.tab_main));
    ...
    void onPasswordClick() {
        startActivity(new Intent(this, EditModeActivity.class));
        fabMenu.collapse();
    }
